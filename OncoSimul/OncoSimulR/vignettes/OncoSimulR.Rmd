...
In the case of frequency dependent fitness simulations, the fitness effects are 
reevaluated in each iteration of the algorithm, so that birth rate, death rate 
or both, depending the model used, change and be maintained updated.
