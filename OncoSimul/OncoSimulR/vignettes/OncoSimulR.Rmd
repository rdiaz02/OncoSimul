...
* From version 2.9.10, you can use simulations in a frequency dependent fitness 
  way, that is, puting the fitness specifications as functions of the frequecies 
  of the clones, and evaluating frequently the fitness across the simulation (see
  section \@ref(FDF)).
...
See section \@ref(FDF) for more details and examples.
