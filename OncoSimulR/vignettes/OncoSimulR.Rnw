...
also, other types of restrictions in the accumulation of genes, as
...
model in \cite{Hjelm2006} where all mutations might be allowed to occur,
...
In contrast to section \ref{sv}, the joint mutant has decreased viability:
