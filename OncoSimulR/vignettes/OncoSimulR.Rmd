...
fitness to frequencies of other genotypes. (We also use a data frame
with $g + 1$ columns; each of the first $g$ columns contains a 1 or
a 0 indicating that the gene of that column is mutated or
