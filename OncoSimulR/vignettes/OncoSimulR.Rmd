...
provides a summary of the key details of OncoSimulR. (An explanation
of the meaning of terms specific to the GSR table is available from
...
|&nbsp; Spatial Structure| No Spatial Structure (perfectly mixed, no migration)|
...
par(las = 1, cex = 0.85)
plot(tmp, type = "stacked", plotDiversity = TRUE,
     legend.ncols = 4, ylim = c(0, 5200), xlim = c(0, 1500),
     thinData = TRUE, thinData.keep = 0.5)
``` 
...
Since the earlier versions, OncoSimulR has provided information to
