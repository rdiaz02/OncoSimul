...
(Many of the comments on this section need to use ideas discussed in
other places of this document. If you read this section first, you
might want to come back after reading the relevant parts. In
addition, much of the code in this section is not executed during
the building of the vignette, to keept vignette build time
reasonable and prevent use huge amounts of RAM.)
...
factors that affect speed and size.
...
with an 8-core Intel Xeon E3-1505M CPU, running Debian GNU/Linux.
...
Median Number of Clones

Median Number of Iterations

Median Final Time

Median Total Population Size
