...
# How long does it take? How fast is OncoSimulR? How much space do the return objects take? {#timings}
...
## Can we use population sizes larger than $10^{10}$? {#popgtzx}
...
## For what not well suited and why and tradeoffs? {#whatnotfor}
...
## Does OncoSimulR keep track of individuals or of clones? And how can you keep track of such large populations?
