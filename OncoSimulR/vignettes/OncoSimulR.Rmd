...
The following adapted example is based on Wu A, Ross D. (2016). 
...
|                  | CS               | CT               | PA               |
|------------------|------------------|------------------|------------------|
|**CS**            | bG – cG – cS     | bG – cG – cS     | bG – cG – cS -cI |
...
0.2, WT population produces inhibitory compounds which harm WT and affect its 
...
for resources, but CT takes over PA given its larger population size and CT population 
...
The following example is based on Barton et al. (2018). This model assumes that
...
we model a more complex scenario. 
