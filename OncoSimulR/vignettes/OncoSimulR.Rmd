...
provide the details on how the LODs are obtained. I provide two
...
Szendro et al.), as well as a single LOD that is the first path to
arrive at the genotype that eventually becomes the most populated
genotype at the final time (and, in this sense, agrees with the LOD
of Szendro et al.). See the help file for details.
