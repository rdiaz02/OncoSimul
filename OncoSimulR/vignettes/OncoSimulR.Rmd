...
## Some questions you can address with the help of OncoSimulR {#whatfor}
...
## Questions that can be addressed with OncoSimulR{#oq}

The examples above focus on the mechanics. Here, we will list some
general scientific questions in cancer genomics and evolutionary
...
want many more scenarios, many more simulations, etc.
