...
mutated, etc). In the example below, the birth rate of genotype "A"
$= 1.2 + 0.5* f\_1\_2$. See the documentation of `allFitnessEffects`
for further details. Genotypes not defined explicitly have a fitness
of 0. (In the data frame creation, we use `stringsAsFactors = FALSE`
...
vignetted, for example in \@ref(ex-ochs) or \@ref(bauer) or
