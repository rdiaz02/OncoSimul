...
This model evaluates if each locus is either high or low fitness (which
corresponds to "e" parameter value), with a systematic change between each
neighbor.
...
@brouillet_magellan:_2015], all loci are arranged sequentially.  Each
locus interacts with its physical neighbors. For each pair of interacting
loci, there is an associated cost if both alleles are not identical (and
