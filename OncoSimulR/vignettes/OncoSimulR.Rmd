...
Will obtain 100 simulations. This represents a small number of simulations
in a particular epistasis scenario we are interested in. The results I
show are for a laptop with an 8-core Intel Xeon E3-1505M CPU, running
Debian GNU/Linux. (Most of the code in this section is not executed during
the building of the vignette, to keept vignette build time reasonable and
prevent using huge amounts of RAM. All of the code, ready to be sourced
and run is available from zz).
...
And we obtain times, sizes of objects and summaries of numbers of clones,
iterations, and final times doing:
...
table and table \@ref(tab:timing1) for the McFL models only reflecting
sampling variation).
...
## Can I have population sizes larger than $10^{10}$ {#popgt1010}
