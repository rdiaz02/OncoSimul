...
example, suppose a we have a five loci genotype and suppose that you want
to stop the simulations only if genotypes ``A'', ``B, E'' or ``A, B, C, D,
E'' reach fixation. You do not want to stop it if, say, genotype ``A, B,
E'' reaches fixation. To specify genotypes, you prepend the genotype
combinations with a ``_,'', and that tells OncoSimulR that you want
fixation of *genotypes*, not just gene combinations.

And of example of the differences between the mechanisms can be seen from
this code:
...
sgsp1 ## often you will stop on gene combinations that
...
This will probably be awfully confusing and is not tested formally. Let me
know if you think this is an important feature.
