...
```{r tqex, fig.width=5, fig.height=8}
...
```{r iep1x1,fig.width=5, fig.height=7}
...
plot(pancr)
``` 
```{r pancr2p, fig.width=5, fig.height=8}
## 2. Simulate from it. 
...
<!-- %                      onlyCancer = FALSE)
-->
```{r iep2x2,fig.width=5, fig.height=7}
...
```{r baux1,fig.width=5, fig.height=8}
par(mfrow = c(3, 1))
## First, drivers
...
```{r mcf1sx1,fig.width=5, fig.height=8}
par(mfrow  = c(2, 1))
...
```{r tmpmx1,fig.width=5, fig.height=3.8}
par(las = 1, cex = 0.85)
plot(tmp, addtot = TRUE, log = "", plotDiversity = TRUE,
     thinData = TRUE, thinData.keep = 0.5)
``` 
```{r tmpmx2,fig.width=5, fig.height=3.8}
par(las = 1, cex = 0.85)
...
```{r tmpmx3,fig.width=5, fig.height=8}
par(mfrow = c(2, 1))
...
use a drivers plot:
```{r tmpmdx5,fig.width=5, fig.height=3}
par(las = 1, cex = 0.85)
plot(tmp, addtot = TRUE, log = "", plotDiversity = TRUE,
     thinData = TRUE, thinData.keep = 0.5)
``` 
```{r tmpmdx6,fig.width=5, fig.height=3}
par(las = 1, cex = 0.85)
plot(tmp, type = "stacked", plotDiversity = TRUE,
...
```{r tmpmdx7,fig.width=5, fig.height=4.3}
