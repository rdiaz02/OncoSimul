...
# Measures of evolutionary predictability and diversity
...
references therein). We provide three: Lines of Descent (LOD) and
Paths to the Maximum (POM), as in @szendro_predictability_2013, and
a simple measure of diversity of the actual genotypes sampled. We
will use again the \@ref(pancreas) example:
...
pancr8 <- oncoSimulPop(16, pancr, model = "Exp", keepPhylog = TRUE)

POM(pancr8)
LOD(pancr8)

## No need for them to be the same or different
diversityPOM(POM(pancr8))
diversityLOD(LOD(pancr8))

sampledGenotypes(samplePop(pancr8))
