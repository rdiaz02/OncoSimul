...
## Stochastic detection mechanism and minimum number of drivers {#and_drvprob}
...
# Further comments and examples about time, size, and simulation limits {#moretiming}
