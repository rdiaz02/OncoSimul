...
equations for Lotka-Volterra model of competition: $\frac{dn_1}{dt}
...
fe_pred_prey <-
    allFitnessEffects(
        genotFitness =
            G_fe_LV(1.5, 1.4, 10000, 4000, 0.6, -0.5,
...
fe_pred_prey <-
    allFitnessEffects(
        genotFitness =
            G_fe_LV(1.5, 1.4, 100, 40, 0.6, -0.5,
                  gt = c("WT","prey", "Predator")),
        frequencyDependentFitness = TRUE,
        frequencyType = "abs")
...
$$\dv{n_1}{t} = r n_1 - a c n_1 n_2$$
$$\dv{n_2}{t} = \epsilon a c n_1 n_2 - \delta n2$$
