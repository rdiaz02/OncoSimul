...
p. 9), "(...)  $s_p$ is the ﬁtness disadvantage conferred by a
...
s_p)^p}$ then we are back in the "positive means fitness advantage
...
denominator. McFarland writes is as (I copy verbatim from the fourth
...
so we are going from the "(...) $s_p$ is the ﬁtness disadvantage
