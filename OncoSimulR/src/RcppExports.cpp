...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type userVars(userVarsSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type rules(rulesSEXP);
