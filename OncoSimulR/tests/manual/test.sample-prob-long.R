...
test_that("Increasing cPDetect decreases time, Exp" , {
    ...
    for(tries in 1:max.tries) {
        sa <- oncoSimulPop(n,
                           ...
                           initSize = 1000,
                           keepEvery = -9,
                           detectionProb(p2 = NULL, n2 = NULL, cPDetect = 1e-5),
                           finalTime = 100000,
                           checkSizePEvery = 50,
                           PDBaseline = 500,
                           onlyCancer = FALSE,
        ...
        sb <- oncoSimulPop(n,
                           ...
                           initSize = 1000,
                           keepEvery = -9,
                           detectionProb(p2 = NULL, n2 = NULL, cPDetect = .01),
                           finalTime = 100000,
                           checkSizePEvery = 50,
                           PDBaseline = 500,
                           onlyCancer = FALSE,
...
test_that("Increasing p2 decreases time, Exp" , {
    ...
    for(tries in 1:max.tries) {
        sa <- oncoSimulPop(n,
                           ...
                           initSize = 2000,
                           keepEvery = -9,
                           detectionProb(p2 = .1, n2 = 8500, cPDetect = NULL),
                           finalTime = 100000,
                           checkSizePEvery = 10,
                           PDBaseline = 1100,
                           onlyCancer = FALSE,
        ...
        sb <- oncoSimulPop(n,
                           ...
                           initSize = 2000,
                           keepEvery = -9,
                           detectionProb(p2 = .8, n2 = 8500, cPDetect = NULL),
                           finalTime = 100000,
                           checkSizePEvery = 10,
                           PDBaseline = 1100,
                           onlyCancer = FALSE,
...
test_that("Increasing n2 increases time, Exp" , {
    ...
    for(tries in 1:max.tries) {
        sa <- oncoSimulPop(n,
                           ...
                           initSize = 5000,
                           keepEvery = -9,
                           detectionProb(p2 = .6, n2 = 7000, cPDetect = NULL),
                           finalTime = 100000,
                           checkSizePEvery = 50,
                           PDBaseline = 2100,
                           onlyCancer = FALSE,
        ...
        sb <- oncoSimulPop(n,
                           ...
                           initSize = 5000,
                           keepEvery = -9,
                           detectionProb(p2 = .6, n2 = 2500, cPDetect = NULL),
                           finalTime = 100000,
                           checkSizePEvery = 50,
                           PDBaseline = 2100,
                           onlyCancer = FALSE,
...
test_that("Increasing checkSizePEvery increases time, Exp" , {
    ...
    for(tries in 1:max.tries) {
        sa <- oncoSimulPop(n,
                           ...
                           initSize = 2000,
                           keepEvery = -9,
                           detectionProb(p2 = .1, n2 = 1500, cPDetect = NULL),
                           finalTime = 100000,
                           checkSizePEvery = 50,
                           PDBaseline = 1100,
                           onlyCancer = FALSE,
