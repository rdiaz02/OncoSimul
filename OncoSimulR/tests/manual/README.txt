...
could end up in unlikely cases). Note that we will rarely want to use
something like try_again (available from the github version of testthat)
or repeated tries (e.g.,
...
and that is NOT a proper test for these cases.
