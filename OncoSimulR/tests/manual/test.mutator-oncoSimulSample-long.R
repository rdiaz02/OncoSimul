...
test_that("per-gene-mut rates and mutator", {
    ...
    expect_true( wilcox.test(m1.mutator2$popSummary[, "NumClones"], m1.mutator1$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    expect_true( wilcox.test(m1.mutator1$popSummary[, "NumClones"], m1.mutator0$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    expect_true( wilcox.test(m2.mutator2$popSummary[, "NumClones"], m2.mutator1$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    expect_true( wilcox.test(m2.mutator1$popSummary[, "NumClones"], m2.mutator0$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    ...
    ## mutator.
    expect_true( wilcox.test(m2.mutator0$popSummary[, "NumClones"], m1.mutator0$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    expect_true( wilcox.test(m2.mutator1$popSummary[, "NumClones"], m1.mutator1$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
    expect_true( wilcox.test(m2.mutator2$popSummary[, "NumClones"], m1.mutator2$popSummary[, "NumClones"],
                             alternative = "greater")$p.value < p.value.threshold)
