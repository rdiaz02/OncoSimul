...
SEXP BNB_Algo5(SEXP restrictTable_,SEXP numDrivers_,SEXP numGenes_,SEXP typeCBN_,SEXP birthRate_, SEXP s_, SEXP death_,SEXP mu_,SEXP initSize_,SEXP sampleEvery_,SEXP detectionSize_,SEXP finalTime_,SEXP initSize_species_,SEXP initSize_iter_,SEXP seed_gsl_,SEXP verbose_,SEXP speciesFS_,SEXP ratioForce_,SEXP typeFitness_,SEXP maxram_,SEXP mutatorGenotype_,SEXP initMutant_,SEXP maxWallTime_,SEXP keepEvery_,SEXP alpha_,SEXP sh_,SEXP K_,SEXP detectionDrivers_, SEXP onlyCancer_, SEXP errorHitWallTime_, SEXP maxNumTries_,  SEXP errorHitMaxTries_, SEXP minDDrPopSize_, SEXP extraTime_);
R_CallMethodDef callMethods[]  = {
  {"C_BNB_Algo5", (DL_FUNC) &BNB_Algo5, 34},
  {NULL, NULL, 0}
};
