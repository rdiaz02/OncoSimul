...
** first
  ...
  - [ ] When mutation rate == dummyMutationRate, wouldn't it make sense to
  ...
  never mutate and should never mutate. Recall exchange with Mather
  about mutation = 0.
